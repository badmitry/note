...
class MainActivityTest {
    ...
    fun check_data_is_displayed() {
        onView(withId(R.id.rv_notes)).perform(RecyclerViewActions.scrollToPosition<MainAdapter.NoteViewHolder>(1))
        onView(withText(testNotes[1].notes)).check(matches(isDisplayed()))
    }
}